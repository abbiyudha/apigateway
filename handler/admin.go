...
func AdminProfile() echo.HandlerFunc {
	return func(c echo.Context) error {
		...
		var baseURL = "https://admin-abbiyudha.cloud.okteto.net/admin"
...
func CreateAdmin() echo.HandlerFunc {
	return func(c echo.Context) error {
		var (
			...
			baseURL = "https://admin-abbiyudha.cloud.okteto.net/create/admin"
		)
		c.Bind(&data)
...
func Login() echo.HandlerFunc {
	return func(c echo.Context) error {
		var (
			...
			baseURL = "https://admin-abbiyudha.cloud.okteto.net/login"
		)
		c.Bind(&data)
...
func UpdateAdmin() echo.HandlerFunc {
	return func(c echo.Context) error {
		var (
			...
			baseURL = "https://admin-abbiyudha.cloud.okteto.net/update"
		)
		c.Bind(&data)
...
func DeleteAdmin() echo.HandlerFunc {
	return func(c echo.Context) error {
		...
		var baseURL = "https://admin-abbiyudha.cloud.okteto.net/delete"
